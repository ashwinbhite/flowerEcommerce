...
public class PDFGenerator {
	...
	public static void createPdf(ArrayList productList)
	{
	    Document document = new Document();
	    try
	    {
	        PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream("C:\\Users\\anirudh.patil\\Desktop\\invoice.pdf"));
	        document.add(new Paragraph("ORIGINAL BILL OF SUPPLY"));
	        document.open();
	        ...
	        for(int i=0;i< productList.size();i++) {
	        	...
	        	PdfPCell cellSr = new PdfPCell(new Paragraph(""+i));
	        	cellSr.setBorderColor(BaseColor.BLACK);
	        	cellSr.setPaddingLeft(10);
